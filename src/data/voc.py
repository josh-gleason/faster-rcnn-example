...
def create_voc_targets(data, labels, data_transform, anchor_boxes, min_shape=(600, 600), max_shape=(1000, 1000),
                       ...
                       mark_max_gt_anchors=True, random_flip=False):
    flipped = False
    ...
    return data_transform(data), (anchor_obj_final, anchor_loc_final, gt_boxes, gt_class_labels, gt_image_id,
                                  ignore, valid_shape, orig_img)
