...
class DynamicResize:
    ...
    def __call__(self, img):
        ...
        return tvtf.resize(img, (scaled_height, scaled_width), interpolation=self.interpolation)
...
def faster_rcnn_collate_fn(batch):
    ...
    batch = [(b[0], (b[1][0], b[1][1], boxes, labels, counts, batch_idx, b[1][-5]))
    ...
    return data, (anchor_obj, anchor_loc, gt_boxes, gt_class_labels, gt_count, data_batch_idx, gt_image_ids,
                  gt_difficult_labels, gt_ignore_labels, valid_shapes, imgs)
